# CLAUDE.md — Hướng dẫn cho Claude làm việc trong kho mã này

Tài liệu này dành cho Claude (và các agent dẫn xuất) khi làm việc trong kho mã của
...
- **Quy chuẩn cao nhất** mà mọi tài liệu phải tuân theo là
  ...
  _phạm vi & ranh giới dự án_ thì file này (CLAUDE.md) là nguồn sự thật.
